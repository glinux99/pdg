...
(function ($) {
    ...
    // countdown timer
    function makeTimer() {
        var endTime = new Date("24 May 2023 00:00:00 GMT+02:30");
        ...
        $("#cb-days").html(days + "<p class='mb-0'>Jours</p>");
        $("#cb-hours").html(hours + "<p class='mb-0'>Heures</p>");
        $("#cb-minutes").html(minutes + "<p class='mb-0'>Min</p>");
        $("#cb-seconds").html(seconds + "<p class='mb-0'>Sec</p>");
        $("#sb-days").html(days + "<p class='mb-0'>Jours</p>");
        $("#sb-hours").html(hours + "<p class='mb-0'>Heures</p>");
        $("#sb-minutes").html(minutes + "<p class='mb-0'>Min</p>");
        $("#sb-seconds").html(seconds + "<p class='mb-0'>Sec</p>");
        $("#up-days").html(days + "<p class='mb-0'>Jours</p>");
        $("#up-hours").html(hours + "<p class='mb-0'>Heures</p>");
