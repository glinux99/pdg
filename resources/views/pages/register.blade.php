                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-6">
                                        <div class="form-group">
                                            <label class="text-light-white fs-14">Votre nom <span class="text-danger">*</span></label>
                                            <input type="text" name="#" class="form-control form-control-submit" placeholder="" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-6">
                                        <div class="form-group">
                                            <label class="text-light-white fs-14">Votre prenom <span class="text-danger">*</span></label>
                                            <input type="text" name="#" class="form-control form-control-submit" placeholder="" required>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label class="text-light-white fs-14">Adresse Email <span class="text-danger">*</span></label>
                                            <input type="email" name="#" class="form-control form-control-submit" placeholder="" required>
                                        </div>
                                        <div class="form-group">
                                            <label class="text-light-white fs-14">Mot de passe (8 characteres minimum) <span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group">
                                            <label class="text-light-white fs-14">Confirmez le mot de passe <span class="text-danger">*</span></label>
                                            <input type="password" id="password-field" name="#" class="form-control form-control-submit" value="pdg@2022" placeholder="pdg-babonpassword" required>
                                            <div data-name="#password-field" class="fa fa-fw fa-eye field-icon toggle-password"></div>
                                        </div>
                                        ...
                                        <div class="form-group text-center">
                                            <p class="text-light-black mb-0">Vous n'avez pas de compte? <a href="login.html" style="color:darkblue;">Se connecter</a>
                                            </p>
                                        </div> <span class="text-light-black fs-12 terms  mb-5">Vous acceptez nos<a href="#" style="color:darkblue;"> Termes</a> ainsi que la <a href="#" style="color:darkblue;"> Politique du parti.</a></span>
                                    </div>
                                </div>
                            </form>
                        </div>
